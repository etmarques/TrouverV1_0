...
export const criaCampoFalta = ()=> {
    ...
    const elB = paragrafo1.criaDiv('row', ' g-2', ' ps-4', '', '', 'elB', '');

    const elB1 = paragrafo1.criaDiv('form-floating', ' col-5', '', '', '', 'elB1', '');
    const elB11 = paragrafo1.criaInput('form-control', 'text', 'floatingInput', '', '', 'none');
    const elB12 = paragrafo1.criaLabel('', 'floatingInput', 'Nome do colaborador que faltou');

    const elB2 = paragrafo1.criaDiv('form-floating', ' col', '', '', '', 'elB2', '');
    const elB21 = paragrafo1.criaInput('form-control', 'date', 'floatingInput', '', '', 'none');
    const elB22 = paragrafo1.criaLabel('', 'floatingInput', 'De');

    const elB3 = paragrafo1.criaDiv('form-floating', ' col', '', '', '', 'elB3', '');
    const elB31 = paragrafo1.criaInput('form-control', 'date', 'floatingInput', '', '', 'none');
    const elB32 = paragrafo1.criaLabel('', 'floatingInput', 'Até');

    const elB4 = paragrafo1.criaDiv('col-md-2', ' ps-2', ' bg-secondary', ' text-white', ' rounded-2', 'elB4', '');
    ...
    const elC = paragrafo1.criaDiv('d-flex', '  justify-content-between', '  align-items-end', '', '', 'elC', '');
    const elC1 = paragrafo1.criaDiv('mt-1', '  ms-5', '', '', '', 'elC1', 'Motivo:');
    ...
    const elC12 = paragrafo1.criaDiv('form-check', '', '', '', '', 'elC11', '');
    ...
    const elC13 = paragrafo1.criaDiv('form-check', '', '', '', '', 'elC11', '');
    ...
    const elC2 = paragrafo1.criaDiv('form-floating', '  col-6', ' visually-hidden', '', '', `elC2${sizeFaltas}`, '');
    const elC21 = paragrafo1.criaInput('form-control', 'text', 'floatingInput', '', '', 'none');
    const elC22 = paragrafo1.criaLabel('', 'floatingInput', 'Nome do colaborador substituto');
